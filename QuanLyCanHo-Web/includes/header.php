...
$adminMenus = [
    ...
    ['label' => 'Báo cáo', 'url' => '/admin/bao-cao/index.php'],
];
...
<body>
    <header>
        <nav>
            <div class="brand">
                <a href="<?= url('/') ?>">Quản lý căn dịch vụ</a>
            </div>
            ...
            <?php if ($loggedIn): ?>
                <ul class="menu">
                    <?php foreach ($menuItems as $item): ?>
                        <li>
                            <a href="<?= htmlspecialchars(url($item['url']), ENT_QUOTES, 'UTF-8') ?>"><?php echo htmlspecialchars($item['label'], ENT_QUOTES, 'UTF-8'); ?></a>
                        </li>
                    <?php endforeach; ?>
                </ul>
                ...
                <div class="user-box">
                    ...
                    <a href="<?= url('/auth/logout.php') ?>">Đăng xuất</a>
                </div>
            <?php else: ?>
                <div class="guest-box">
                    <a href="<?= url('/auth/login.php') ?>">Đăng nhập</a>
                </div>
            <?php endif; ?>
        </nav>
    </header>
